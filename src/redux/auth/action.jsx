import { SET_USER, SHOW_LOADING_LOGIN_MODAL, SHOW_LOGIN_MODAL, SIGN_IN_REQUEST,SHOW_SIGNUP_MODAL, SIGN_UP_REQUEST ,SHOW_LOADING_SIGNUP_MODAL} from "../actionTypes";
...
export const setShowLoadingSignUpModal = (show) => ({
    type: SHOW_LOADING_SIGNUP_MODAL,
    payload: show
})
