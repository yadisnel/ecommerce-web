...
export const SHOW_LOADING_LOGIN_MODAL = "AUTH/SHOW_LOADING_LOGIN_MODAL";
export const SIGN_IN_REQUEST = "AUTH/SIGN_IN_REQUEST";
export const SIGN_UP_REQUEST = "AUTH/SIGN_UP_REQUEST";
export const SHOW_SIGNUP_MODAL = "AUTH/SHOW_SIGNUP_MODAL";
export const SHOW_LOADING_SIGNUP_MODAL = "AUTH/SHOW_LOADING_SIGNUP_MODAL";
