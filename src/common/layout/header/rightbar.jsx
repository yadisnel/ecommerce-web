...
import { FileText, LogIn, Mail, User, MessageSquare, Bell, Minimize, Search, ShoppingCart, Minus, Plus, X } from 'react-feather/dist/index';
...
setTranslations({ en, es, pt, fr, du, cn, ae, sr });
          ...
          <li className="language-nav">
            <div className={`translate_wrapper ${langdropdown ? 'active' : ''}`}>
              ...
              <div className={`more_lang ${langdropdown ? 'active' : ''}`}>
                ...
                <div className="lang" onClick={() => handleSetLanguage('sr')}><i className="flag-icon flag-icon-us"></i><span className="lang-txt">{Serbian}</span></div>
