...
//import Allfilters from '../../../common/components/application/ecommerce-app/filters/allfilters'
...
const Product = (props) => {
  ...
  const data = useSelector(content => content.productItems);
  // eslint-disable-next-line 
  const [layoutColumns, setLayoutColumns] = useState(3);

  const symbol = useSelector(content => content.symbol);
          ...
          <div className="product-wrapper-grid">
            {searchKeyword.length > 0 ?
              ...
              <Row className="gridRow">
                  ...
                  <div className={`${layoutColumns === 3 ? 'col-xl-3 col-sm-6 xl-4 col-grid-box' : 'col-xl-' + layoutColumns}`} >
                    <Card>
                      <div className="product-box">
                        <div className="product-img">
                         <img className="img-fluid"  src={require("../default/1.jpg")} alt="" />
